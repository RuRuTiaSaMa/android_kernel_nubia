...
//Add for TP i2c error and reset it for
#define NUBIA_TP_HW_SW_RESET
/* cause selinux in /data, move tp node to kernel */
//#define NUBIA_TP_NODE_IN_KERNEL
#define NUBIA_SYNAPTICS_RESUME_WORKQUEUE
/* nubia for palm sleep */
#define NUBIA_SYNAPTICS_PALM_SUPPORT
/* nubia for swap buttons */
#define NUBIA_SYNAPTICS_SWAPBUTTON_SUPPORT

/* enable synaptics pinctrl */
#define NUBIA_SYNAPTICS_PINCTRL

/* enable synaptics charge bit */
//#define OPEN_CHARGE_BIT

#define BACK_THRESHOLD_ADDRESS 0x20e
#define HOME_THRESHOLD_ADDRESS 0x20c
#define MENU_THRESHOLD_ADDRESS 0x20d

//for calling
#define BACK_THRESHOLD_NORMAL 166
#define HOME_THRESHOLD_NORMAL 147
#define MENU_THRESHOLD_NORMAL 147

#define BACK_THRESHOLD_CALLING 194
#define HOME_THRESHOLD_CALLING 194
#define MENU_THRESHOLD_CALLING 194
...
struct synaptics_rmi4_data {
	bool tp_reset_start;
	int tp_reset_count;
	struct delayed_work tp_reset_work;
